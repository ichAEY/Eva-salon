/* EVA current mobile bundle. Structural modules consolidated 2026-08-31. */

(function(){
  'use strict';
  if(!window.matchMedia || !window.matchMedia('(max-width:767px)').matches) return;

  const PHONE='+79260063922';
  const YANDEX='https://yandex.com/maps/org/yeva/1179517154/';
  const YANDEX_REVIEWS='https://yandex.com/maps/org/yeva/1179517154/reviews/';
  const ADDRESS='Балашиха, д. Павлино, 69';
  const RATING='4,8';
  const RATINGS_COUNT=310;

  const services=[
    ['hair','Женская стрижка','800–1 700 ₽'],
    ['hair','Мужская стрижка','1 000–1 500 ₽'],
    ['hair','Окрашивание волос','Цена по записи'],
    ['hair','Укладка волос','Цена по записи'],
    ['nails','Маникюр','Цена по записи'],
    ['nails','Педикюр','Цена по записи'],
    ['face','Чистка лица','Цена по записи'],
    ['face','Пилинг','Цена по записи'],
    ['face','Инъекционные процедуры','Цена по записи'],
    ['face','Коррекция фигуры','Цена по записи'],
    ['brows','Коррекция бровей','Цена по записи'],
    ['lashes','Услуги для ресниц','Цена по записи'],
  ...
  const works=[
    ...
    {src:'team01.webp',cat:'team',alt:'Команда EVA'}
  ];

  // Только короткие фрагменты отзывов, ранее подтверждённых по карточке EVA в Яндекс Картах.
  const reviews=[{"name": "Екатерина Филина", "text": "Больше, я и моя дочь, посещаем салон красоты Ева. Пользуемся услугами косметолога Юлии.Осталась довольна результатом после процедуры.Юлия ответственная, аккуратная. Профессионал своего дела.\nХочу выразить благодарность мастеру маникюра Олесе.Мастер с большой буквы.\nВсе маникюрные фантазии воплощает в реальность.\nДиректор волшебная женщина.\nСалон часто радует клиентскими днями, бонусами и подарками.\nАдминистраторы приветливые, всегда предложат чай, кофе.В салоне очень благоприятная атмосфера.\nСпасибо большое за вашу заботу о нас.\nПроцветания салону."}, {"name": "Татьяна С.", "text": "Всем здравствуйте. Я хожу в салон относительно не давно, но могу сказать однозначно, что менять своего мастера Олесю я ни на кого не собираюсь…\nДа к сожалению я уехала в другой город, но когда в командировке сразу записываюсь. Руки остаются в ухоженном состоянии очень долго. Мне хватает до следующего раза. Даже не ищу в своем городе мастера…\nБлагодарю! Всегда вежливый персонал. \nОчень полюбила этот салон. "}, {"name": "Олеся Микляева", "text": "Приятно удивлена посещением данного салона! Пришла на маникюр, атмосфера сразу располагает, красиво, чисто, все сотрудники приветливы и вежливы, мне предложили горячий чай и сладости. Мастер Юля произвела очень хорошее впечатление, маникюр супер, осталась очень довольна! \nРекомендую ☺️"}, {"name": "Алена К.", "text": "Потрясающие мастера, настоящие мастера своего дела! \nПро этом обслуживание, клиентоориентированность, профессионализм. Ни один раз полностью сменили внешность и каждый раз вау эффект. На видео выход из темного каштана в блонд, но это результат первого окрашивания.\nСпасибо сотрудникам салона, за теплоту и красоту)"}, {"name": "Валентина", "text": "Хочу выразить огромную благодарность Ирине за её профессионализм и внимательное отношение к клиентам. Каждый визит к ней – это не просто процедура, а настоящее удовольствие и уверенность в результате.\nТак же Ирина– это не просто учитель, а настоящий наставник и источник вдохновения. Её подход к обучению уникален и эффективен, она умеет найти подход к каждому ученику, независимо от уровня подготовки и возраста.\nНа её уроках царит атмосфера творчества и взаимопонимания. Ирина всегда стремится не только передать знания, но и развить в нас любовь к предмету ."}, {"name": "Елена Таранова
. Парикмахер Даша и Эля волшебницы, косметолог Ирина специалист с Большой буквы.\nЖелаю любимому Салону, и особенно владельце Марине, дальнейшего процветания и развития, благодарных гостей и удачи!!\n"}, {"name": "Инна Шульга", "text": "Салон замечательный. С удовольствием хожу к парикмахеру - стилисту Дарье. Если хотите выглядеть замечательно  то вам обязательно надо попасть к ней. Коррекция и окрашивание бровей у Юлии превосходное! Желаю салону процветания! "}, {"name": "Нюта Уралова", "text": "Хочу сказать большое спасибо нашим незаменимым мастерам Дарье и Эле , которые делают нас красивыми каждый раз. Так же они очень позитивные и общительные , могут даже пообщаться с ребёнком в момент стрижки , ребенку с ними очень комфортно и радостно 😊\nМы долго не могли найти подходящего нам мастера для детской стрижке, но именно в Eva нас услышали и приняли наши запросы. \nСын бежит с удовольствием на стрижку ,и это радует.\nПерсонал замечательный , чуткий и отзывчивый 👍 спасибо Вам большое , вы лучшие ! 🌹🙌❤️"}, {"name": "Надежда Аксенова", "text": "Салон просто ОГОНЬ 🔥!!!\nПосещаю его более пяти лет,никаких проблем никогда не возникало !!!\nЗамечательный коллектив,все девочки профессионалы в своей работе!!!\nРекомендую салон всем моим знакомым и тем ,кто сейчас читает мой отзыв!\nСловами не передать какой он замечательный,но стоит раз его посетить и вы останитесь очень довольны и постоянным клиентом!\n"}];
  ...
  @media(max-width:767px){
    ...
    body>*:not(#eva-tanem-v13):not(script):not(style):not(link){display:none!important}
    #eva-tanem-v13{--ink:#2f2926;--soft:#6e625c;--paper:#f6f1eb;--paper2:#fbf8f4;--taupe:#8b7167;--taupe-dark:#715b53;--line:rgba(65,52,47,.13);display:block;width:100%;min-height:100dvh;overflow:clip;background:var(--paper);color:var(--ink);font-family:"Manrope",Arial,sans-serif;font-weight:400}
    #eva-tanem-v13 *{box-sizing:border-box}
    #eva-tanem-v13 button,#eva-tanem-v13 a{font:inherit;-webkit-tap-highlight-color:transparent;color:inherit}
    #eva-tanem-v13 button{cursor:pointer}
  ...
  @media(min-width:768px){#eva-tanem-v13{display:none!important}}
  `;
  ...
  root.innerHTML=`
    ...
    <header class="tn13-hero" id="tn13Top">
      <div class="tn13-shell">
        <div class="tn13-topbar">
          <a class="tn13-brand" href="#tn13Top">EVA</a>
        ...
        <div class="tn13-hero-content">
          <div class="tn13-ticker"><div class="tn13-ticker-track"><span>Салон красоты · Павлино · рейтинг 4,8 · ногти · волосы · косметология</span><span>Салон красоты · Павлино · рейтинг 4,8 · ногти · волосы · косметология</span></div></div>
          <h1>Салон красоты <em>EVA</em></h1>
          <p class="tn13-hero-copy">Ногти, волосы, косметология и другие направления — в одном пространстве в Павлино.</p>
        </div>
        ...
        <div class="tn13-visual" aria-label="Интерьер и работы EVA">
          ...
          <div class="tn13-visual-label">Балашиха · д. Павлино, 69</div>
        </div>
    ...
    <section class="tn13-final" id="tn13Visit">
      <div class="tn13-shell tn13-reveal">
        ...
        <p class="tn13-final-copy">EVA находится в Павлино, Балашиха, по адресу д. Павлино, 69. Актуальный статус и расписание работы доступны в Яндекс Картах.</p>
        ...
        <iframe class="tn13-map" loading="lazy" src="https://yandex.ru/map-widget/v1/?ll=37.961358%2C55.729412&z=17" title="Карта EVA"></iframe>
        <div class="tn13-final-facts"><span><strong>Яндекс</strong><small>часы работы</small></span><span><strong>4,8</strong><small>рейтинг</small></span><span><strong>${services.length}</strong><small>услуг</small></span></div>
      </div>
    </section>

    <footer class="tn13-footer"><div class="tn13-shell"><strong>EVA</strong>Цифровой офис TANEM.RU</div></footer>
  ...
  let serviceCat='hair',expanded=false;
...
(function(){
'use strict';
const EVA_V23_REFINED=true;
if(!window.matchMedia||!window.matchMedia('(max-width:767px)').matches)return;
const root=document.getElementById('eva-tanem-v13'); if(!root)return;
const YANDEX='https://yandex.com/maps/org/yeva/1179517154/';
const YANDEX_RU='https://yandex.ru/maps/org/yeva/1179517154/';
const YANDEX_REVIEWS='https://yandex.com/maps/org/yeva/1179517154/reviews/';
const ROUTE='https://yandex.ru/maps/?rtext=~55.729412%2C37.961358&rtt=auto';
const PHONE='+79260063922';
...
[
['Волосы','Женская стрижка','800–1 700 ₽'],
['Волосы','Мужская стрижка','1 000–1 500 ₽'],
['Волосы','Окрашивание волос','Цена по записи'],
['Волосы','Укладка волос','Цена по записи'],
['Маникюр','Маникюр','Цена по записи'],
['Маникюр','Педикюр','Цена по записи'],
['Косметология','Чистка лица','Цена по записи'],
['Косметология','Пилинг','Цена по записи'],
['Косметология','Инъекционные процедуры','Цена по записи'],
['Косметология','Коррекция фигуры','Цена по записи'],
['Брови','Коррекция бровей','Цена по записи'],
['Ресницы','Услуги для ресниц','Цена по записи'],
['Эпиляция','Шугаринг','Цена по записи'],
['Эпиляция','Восковая эпиляция','Цена по записи'],
['Перманент','Перманентный макияж','Цена по записи']
...
const css=document.createElement('style'); css.id='eva-final-v22-style'; css.textContent=`
@media(max-width:767px){
#tn13Intro{display:none!important} #eva-tanem-v13{background:#f6f0e9!important;color:#181512!important}
#eva-tanem-v13 .tn13-hero{height:744px!important;min-height:744px!important;padding:0!important;background:linear-gradient(180deg,#f8f4ee 0%,#f8f4ee 90%,#f7f2eb 100%)!important;position:relative!important;overflow:hidden!important}#eva-tanem-v13>.tn13-footer{display:none!important}
...
const sectionIds=['tn13Portfolio','tn13Services','tn38About','tn13Team','tn13Reviews','tn13Visit'];const sectionNav=document.createElement('nav');sectionNav.className='tn23-section-nav';sectionNav.setAttribute('aria-hidden','true');sectionNav.innerHTML=[['tn13Portfolio','Портфолио'],['tn13Services','Услуги'],['tn38About','О нас'],['tn13Team','Команда'],['tn13Reviews','Отзывы'],['tn13Visit','Визит']].map((x,i)=>`<button type="button" data-section="${x[0]}" class="${i===0?'active':''}">${x[1]}</button>`).join('');hero.insertAdjacentElement('afterend',sectionNav);
...
const REAL_REVIEW_DATA=[["Екатерина Филина", "Больше, я и моя дочь, посещаем салон красоты Ева. Пользуемся услугами косметолога Юлии.Осталась довольна результатом после процедуры.Юлия ответственная, аккуратная. Профессионал своего дела.\nХочу выразить благодарность мастеру маникюра Олесе.Мастер с большой буквы.\nВсе маникюрные фантазии воплощает в реальность.\nДиректор волшебная женщина.\nСалон часто радует клиентскими днями, бонусами и подарками.\nАдминистраторы приветливые, всегда предложат чай, кофе.В салоне очень благоприятная атмосфера.\nСпасибо большое за вашу заботу о нас.\nПроцветания салону."], ["Татьяна С.", "Всем здравствуйте. Я хожу в салон относительно не давно, но могу сказать однозначно, что мен